...
const separatorVariants = cva('shrink-0 data-horizontal:w-full data-vertical:self-stretch', {
  variants: {
    variant: {
...
function Separator({ className, variant, orientation = 'horizontal', ...props }) {
  return (
    <SeparatorPrimitive
      data-slot="separator"
