...
function TagFieldSectionDemo({ body = '', initialManualTags = [] }) {
  ...
  return (
    <div className="w-[640px] overflow-hidden rounded-[26px] border-2 border-foreground bg-background">
      <PostEditorTagFieldSection tagField={tagField} tagPlaceholder={postEditorCopy.tagPlaceholder} />
    </div>
  );
}
...
export const Default = {
  render: () => <TagFieldSectionDemo initialManualTags={['공지', '운영']} />,
};
...
export const WithBodyTags = {
  render: () => (
    <TagFieldSectionDemo body="행사 일정과 부스 배치 #일정 #안내를 확인하세요." initialManualTags={['공지']} />
  ),
};
