  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <div className="mx-auto flex w-full max-w-content-wide flex-col items-center justify-center px-5 py-32 sm:px-8 lg:px-10">
        <p className="text-8xl font-black tracking-tight text-foreground">404</p>
        <p className="mt-4 text-xl font-bold text-foreground">페이지를 찾을 수 없어요</p>
        <p className="mt-2 text-sm text-muted-foreground">주소가 잘못됐거나 삭제된 페이지예요.</p>
        <Link
          href="/"
