...
class PostControllerTest {
    ...
    @Test
    @DisplayName("로그인 목록 조회 → 공개 글과 본인 비공개 글 조회")
    ...
    @Test
    @DisplayName("로그인 목록 조회 → 타인 비공개 글 제외")
    ...
    @Test
    @DisplayName("userId 필터는 해당 작성자의 글만 조회")
    ...
    @Test
    @DisplayName("비로그인 userId 필터는 작성자의 공개 글만 조회")
    ...
    @Test
    @DisplayName("작성자 로그인 userId 필터는 본인 공개 글과 비공개 글 조회")
    ...
    @Test
    @DisplayName("다른 사용자 로그인 userId 필터는 작성자의 비공개 글 제외")
    ...
    @Test
    @DisplayName("categoryId 필터는 해당 카테고리 글만 조회")
    ...
    @Test
    @DisplayName("userId와 categoryId 필터를 함께 적용")
    ...
    @Test
    @DisplayName("카테고리가 없는 게시글은 카테고리 응답 필드가 null")
    ...
    @Test
    @DisplayName("비로그인 + 공개 글 단건 조회 → 200")
    ...
    @Test
    @DisplayName("비로그인 + 비공개 글 단건 조회 → 404")
    ...
    @Test
    @DisplayName("로그인 + 본인 비공개 글 조회 → 200")
    ...
    @Test
    @DisplayName("로그인 + 남의 비공개 글 조회 → 404")
    ...
    @Test
    @DisplayName("게시글 작성 시 description과 thumbnailUrl 응답")
    ...
    @Test
    @DisplayName("게시글 작성 시 description 255자 초과 -> 400")
    ...
    @Test
    @DisplayName("게시글 작성 시 thumbnailUrl 255자 초과 -> 400")
    ...
    @Test
    @DisplayName("description과 thumbnailUrl 없이도 게시글 작성")
    ...
    @Test
    @DisplayName("게시글 작성 시 본인 카테고리를 사용할 수 있다")
    ...
    @Test
    @DisplayName("게시글 작성 시 타인 카테고리는 사용할 수 없다")
    ...
    @Test
    @DisplayName("로그인 + 남의 글 PATCH → 403")
    ...
    @Test
    @DisplayName("로그인 + 본인 글 PATCH → 200")
    ...
    @Test
    @DisplayName("게시글 수정 시 description 255자 초과 -> 400")
    ...
    @Test
    @DisplayName("게시글 수정 시 thumbnailUrl 255자 초과 -> 400")
    ...
    @Test
    @DisplayName("게시글 수정 시 본인 카테고리로 변경할 수 있다")
    ...
    @Test
    @DisplayName("게시글 수정 시 타인 카테고리는 사용할 수 없다")
    ...
    @Test
    @DisplayName("로그인 + 없는 글 PATCH → 404")
    ...
    @Test
    @DisplayName("로그인 + 남의 글 DELETE → 403")
    ...
    @Test
    @DisplayName("로그인 + 본인 글 DELETE → 204")
    ...
    @Test
    @DisplayName("로그인 + 없는 글 DELETE → 404")
    ...
    @Test
    @DisplayName("게시글 상세 응답 — authorId(Long), authorUserId(String), authorName, authorProfileId 없음")
    ...
    @Test
    @DisplayName("게시글 목록 응답 — authorId(Long), authorUserId(String), authorName, authorProfileId 없음")
    ...
    // 수정 후
    @Test
    @DisplayName("게시글 상세 authorUserId로 공개 프로필 조회 → 200")
    ...
    @Test
    @DisplayName("유효하지 않은 Bearer 토큰으로 공개 GET → 401")
    ...
    @Test
    @DisplayName("만료된 Bearer 토큰으로 공개 GET → 401")
    ...
    @Test
    @DisplayName("Bearer 아닌 Authorization 헤더로 공개 GET → 401")
    ...
    @Test
    @DisplayName("유효한 토큰으로 공개 GET → 200")
    ...
    @Test
    @DisplayName("refresh token으로 보호 API 요청 → 401")
