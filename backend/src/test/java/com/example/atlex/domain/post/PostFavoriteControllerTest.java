...
class PostFavoriteControllerTest {
    ...
    @Test
    @DisplayName("즐겨찾기 등록 성공 → 200, favorited=true")
    ...
    @Test
    @DisplayName("중복 즐겨찾기 요청해도 멱등하게 favorited=true")
    ...
    @Test
    @DisplayName("soft delete된 게시글 즐겨찾기 → 404")
    ...
    @Test
    @DisplayName("비공개 게시글에 비작성자가 즐겨찾기 → 404")
    ...
    @Test
    @DisplayName("비공개 게시글에 작성자 본인이 즐겨찾기 → 200")
    ...
    @Test
    @DisplayName("즐겨찾기 해제 성공 → 200, favorited=false")
    ...
    @Test
    @DisplayName("즐겨찾기하지 않은 상태에서 해제해도 에러 없이 favorited=false")
    ...
    @Test
    @DisplayName("내 즐겨찾기 목록 → 최근 저장순으로 조회")
    ...
    @Test
    @DisplayName("내 즐겨찾기 목록은 다른 사용자의 즐겨찾기와 격리된다")
    ...
    @Test
    @DisplayName("즐겨찾기한 뒤 soft delete된 게시글은 목록에서 제외된다")
    ...
    @Test
    @DisplayName("비로그인 즐겨찾기 목록 조회 → 401")
