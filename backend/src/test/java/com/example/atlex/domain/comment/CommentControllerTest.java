...
class CommentControllerTest {
    ...
    @Test
    @DisplayName("로그인 + 공개 게시글 댓글 작성 → 201")
    ...
    @Test
    @DisplayName("댓글 작성 시 빈 content → 400")
    ...
    @Test
    @DisplayName("댓글 작성 시 content 1000자 초과 → 400")
    ...
    @Test
    @DisplayName("비공개 게시글에 비작성자가 댓글 작성 → 404")
    ...
    @Test
    @DisplayName("비공개 게시글에 작성자 본인이 댓글 작성 → 201")
    ...
    @Test
    @DisplayName("비로그인 + 공개 게시글 댓글 목록 조회 → 200")
    ...
    @Test
    @DisplayName("비로그인 + 비공개 게시글 댓글 목록 조회 → 404")
    ...
    @Test
    @DisplayName("댓글 목록은 createdAt ASC, id ASC 순으로 반환한다")
    ...
    @Test
    @DisplayName("빈 content 로 댓글 수정 → 400")
    ...
    @Test
    @DisplayName("soft delete된 게시글의 댓글 수정 → 404")
    ...
    @Test
    @DisplayName("비공개로 전환된 게시글의 댓글을 작성자 본인이 수정 → 200")
    ...
    @Test
    @DisplayName("게시글 작성자가 타인 댓글 삭제 → 204")
    ...
    @Test
    @DisplayName("soft delete된 게시글의 댓글 삭제 → 404")
